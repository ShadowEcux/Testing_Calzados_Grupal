<?php
    ...
    switch($opcion){
        case 1:
            $consulta = "INSERT INTO usuario (nombre, apellidoP, apellidoM, DNI, direccion,celular,usuario,pasword, idRol) VALUES('$nombre', '$apellidoP', '$apellidoM', '$DNI', '$direccion', '$celular', '$usuario', '$pasword','$idRol') ";			
        ...
        case 3:        
            ...
            break;
        case 4:    
            $consulta = "SELECT *, CASE WHEN idRol = 1 THEN 'admin' ELSE 'colaborador' END as rol FROM usuario WHERE idRol = 1";
            $resultado = $conexion->prepare($consulta);
            $resultado->execute();
